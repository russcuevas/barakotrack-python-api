...
class ChatbotController extends Controller
{
    public function query(Request $request)
    {
        ...
        $suggestions = ["How to report a lost item?", "Where is the lost and found office?", "How to claim an item?", "Office Hours"];

        if (str_contains($q, 'where') || str_contains($q, 'location') || str_contains($q, 'office')) {
        ...
        } elseif (str_contains($q, 'report') || str_contains($q, 'lost') || str_contains($q, 'found')) {
            $message = "📝 **Reporting Guide:** Use the navigation menu to report a lost item or surrender a found item with pictures and location tags.";
        }
