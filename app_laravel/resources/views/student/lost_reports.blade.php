                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            @if ($report->image_path)
                                <img src="{{ $report->image_path }}" class="rounded border" width="40" height="40" style="object-fit: cover;" alt="{{ $report->title }}">
                            @endif
                            <div>
            ...
            <div class="modal-body p-4 text-center">
                ...
                <div id="cnnScanningState">
                    <div class="scan-container mb-3">
                        <img id="scanItemImage" src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&q=80"
                            class="w-100 h-100" style="object-fit: cover;" alt="Scanning Item">
                    ...
                    <div class="alert alert-dark py-2 fs-7 m-0 text-warning border-warning">
                        <i class="bi bi-arrow-repeat spin me-1"></i> <span id="scanStatusText">Extracting 1024-dimensional visual feature vectors...</span>
                    </div>
                </div>
                ...
                <div id="cnnResultsState" class="d-none text-start">
                    <div class="d-flex align-items-center justify-content-between pb-2 mb-3 border-bottom">
                        <h6 class="fw-bold m-0 text-dark"><i class="bi bi-magic text-warning me-1"></i> Found Inventory Matches (>45.0% Similarity)</h6>
...
async function startCnnScan(lostId, title, imagePath) {
    ...
    if (imagePath) {
        ...
        imgEl.src = 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&q=80';
    }
                ...
                container.innerHTML = data.matches.map(m => `
                    <div class="card p-3 mb-3 border-warning shadow-sm">
                        <div class="row align-items-center g-3">
                            <div class="col-auto">
                                <img src="${m.image_path || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&q=80'}" class="rounded border" width="65" height="65" style="object-fit: cover;" alt="${m.title}">
                            </div>
                            <div class="col">
